...
<div class="th1">
    <div class="sanpham">
        ...
        <a class="giohang" href="">Thêm vào giỏ</a>
        <img class="love" src="public/user/img/love-removebg-preview.png" alt="">
        <div class="gt">Kem Chống Nắng Toàn Thân Dạng Xịt Image PREVENTION+ Ultra Sheer</div>
        <div class="gia">
    ...
    <div class="sanpham">
        ...
        <div class="gt">Kem Dưỡng Body Trẻ Hóa Da Toàn Thân Image BODY SPA Rejuvenating Body Lotion</div>
        <div class="gia">
    ...
    <div class="sanpham">
        ...
        <div class="giohang">Thêm vào giỏ</div>
        <div class="gt">Kem Dưỡng Da Mặt Phục Hồi Da Image Irescue Post Treatment Recovery Balm</div>
        <div class="gia">
    ...
    <div class="sanpham">
        ...
        <div class="giohang">Thêm vào giỏ</div>
        <div class="gt">Kem Dưỡng Da Mặt Phục Hồi Và Chống Lão Hóa Image MD Restoring Youth Repair Crème</div>
        <div class="gia">
...
<div class="sp">
    <div class="sanpham">
        ...
        <div class="sanpham1">14%</div>
        <div class="giohang1">Thêm vào giỏ</div>
        <div class="gt">Kem Dưỡng Body Trẻ Hóa Da Toàn Thân Image BODY SPA Rejuvenating Body Lotion</div>
        <div class="gia">
            <span class="giamgia">1,400,000₫</span>
            <span class="giamseo">1,190,000₫</span>
